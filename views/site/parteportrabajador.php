...
<?php for ($i = 0; $i < count($trabajadores); $i ++) : ?>
	<tr style="text-align:center">
		<td style="text-align:left"><?= $trabajadores[$i];?></td>
			...
			<td><p style="margin: 0;"><?= Yii::$app->db->createCommand("select count(*) from  ".$sqlforgestion."  where u1.nombre ".$filtrotrabajador." and e1.nombre = 'Resuelto' and extract(year from s1.created_at) = ".$model->ano)->queryscalar();?></p></td>
			<td><p style="margin: 0;"><?= Yii::$app->db->createCommand("select count(*) from  ".$sqlforgestion."  where u1.nombre ".$filtrotrabajador." and e1.nombre = 'Articulado' and extract(year from s1.created_at) = ".$model->ano)->queryscalar();?></p></td>
			<td><p style="margin: 0;"><?= Yii::$app->db->createCommand("select count(*) from  ".$sqlforgestion."  where u1.nombre ".$filtrotrabajador." and e1.nombre = 'Anulado' and extract(year from s1.created_at) = ".$model->ano)->queryscalar();?></p></td>
			<td><p style="margin: 0;"><?= Yii::$app->db->createCommand("select count(*) from  ".$sqlforgestion."  where u1.nombre ".$filtrotrabajador." and e1.nombre = 'Pendiente' and extract(year from s1.created_at) = ".$model->ano)->queryscalar();?></p></td>
...
<?php endfor; ?>
    <tr style="text-align:center; vertical-align:middle; font-weight: bold; background-color: #585858; color: white;">
			...
			<td style="font-size: 1.1em; background-color: #585858; color: white;" class="danger totaltabla"><p  style="margin: 0;"><?= Yii::$app->db->createCommand("select count(*) from  ".$tablasforsqlingreso." where extract(year from s1.created_at) = ".$model->ano)->queryscalar();?></p></td>
			<td style="font-size: 1.1em; background-color: #585858; color: white;" class="danger totaltabla"><p  style="margin: 0;"><?= Yii::$app->db->createCommand("select count(*) from  ".$tablasforsql." where extract(year from s1.created_at) = ".$model->ano)->queryscalar();?></p></td>
			<td style="font-size: 1.1em; background-color: #585858; color: white;" class="danger"><p style="margin: 0;"><?= Yii::$app->db->createCommand("select count(*) from  ".$tablasforsql."  where e1.nombre = 'Resuelto' and extract(year from s1.created_at) = ".$model->ano)->queryscalar();?></p></td>
			<td style="font-size: 1.1em; background-color: #585858; color: white;" class="danger"><p style="margin: 0;"><?= Yii::$app->db->createCommand("select count(*) from  ".$tablasforsql."  where e1.nombre = 'Articulado' and extract(year from s1.created_at) = ".$model->ano)->queryscalar();?></p></td>
			<td style="font-size: 1.1em; background-color: #585858; color: white;" class="danger"><p style="margin: 0;"><?= Yii::$app->db->createCommand("select count(*) from  ".$tablasforsql."  where e1.nombre = 'Anulado' and extract(year from s1.created_at) = ".$model->ano)->queryscalar();?></p></td>
			<td style="font-size: 1.1em; background-color: #585858; color: white;" class="danger"><p style="margin: 0;"><?= Yii::$app->db->createCommand("select count(*) from  ".$tablasforsql."  where e1.nombre = 'Pendiente' and extract(year from s1.created_at) = ".$model->ano)->queryscalar();?></p></td>
			<td style="font-size: 1.1em; background-color: #585858; color: white;" class="danger"><p style="margin: 0;"><?= Yii::$app->db->createCommand("select count(*) from  ".$tablasforsql."  where e2.nombre = 'Sin Comunicación' and extract(year from s1.created_at) = ".$model->ano)->queryscalar();?></p></td>
			<td style="font-size: 1.1em; background-color: #585858; color: white;" class="danger"><p style="margin: 0;"><?= Yii::$app->db->createCommand("select count(*) from  ".$tablasforsql."  where e2.nombre = 'Por Llamar' and extract(year from s1.created_at) = ".$model->ano)->queryscalar();?></p></td>
			<td style="font-size: 1.1em; background-color: #585858; color: white;" class="danger"><p style="margin: 0;"><?= Yii::$app->db->createCommand("select count(*) from  ".$tablasforsql."  where e2.nombre = 'Por Recaudos' and extract(year from s1.created_at) = ".$model->ano)->queryscalar();?></p></td>
			<td style="font-size: 1.1em; background-color: #585858; color: white;" class="danger"><p style="margin: 0;"><?= Yii::$app->db->createCommand("select count(*) from  ".$tablasforsql."  where e2.nombre = 'Por Convenio' and extract(year from s1.created_at) = ".$model->ano)->queryscalar();?></p></td>
            <td style="font-size: 1.1em; background-color: #585858; color: white;" class="danger"><p style="margin: 0;"><?= Yii::$app->db->createCommand("select count(*) from  ".$tablasforsql."  where e2.nombre = 'Por Consulta' and extract(year from s1.created_at) = ".$model->ano)->queryscalar();?></p></td>
			<td style="font-size: 1.1em; background-color: #585858; color: white;" class="danger"><p style="margin: 0;"><?= Yii::$app->db->createCommand("select count(*) from  ".$tablasforsql."  where e3.nombre = 'Ecónomico' and extract(year from s1.created_at) = ".$model->ano)->queryscalar();?></p></td>
			<td style="font-size: 1.1em; background-color: #585858; color: white;" class="danger"><p style="margin: 0;"><?= Yii::$app->db->createCommand("select count(*) from  ".$tablasforsql."  where e3.nombre = 'Salud' and extract(year from s1.created_at) = ".$model->ano)->queryscalar();?></p></td>
			<td style="font-size: 1.1em; background-color: #585858; color: white;" class="danger"><p style="margin: 0;"><?= Yii::$app->db->createCommand("select count(*) from  ".$tablasforsql."  where e2.nombre = 'EN ADMINISTRACIÓN' and extract(year from s1.created_at) = ".$model->ano)->queryscalar();?></p></td>
