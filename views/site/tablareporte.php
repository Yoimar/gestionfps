...
<tbody>
	<?php for ($i = 0; $i < 12; $i ++) : ?>
		<tr>
			<td><?= $meses[$i];?></td>
				...
				<td style="text-align:center"><p style="margin: 0;"><?= Yii::$app->db->createCommand("select count(*) from ".$tablasconjoin."  where ".$filtrounidad." e1.id = 2 and extract(month from s1.created_at)=".($i+1)." and extract(year from s1.created_at) = ".$model->ano." and e2.id <> 15")->queryscalar();?></p></td>
				<td style="text-align:center" class="info"><p style="margin: 0;"><?= Yii::$app->db->createCommand("select count(*) from ".$tablasconjoin."  where ".$filtrounidad." e1.id = 2 and extract(month from s1.created_at)=".($i+1)." and extract(year from s1.created_at) = ".$model->ano." and e2.id = 15")->queryscalar();?></p></td>
	...
	<?php endfor; ?>
    	<tr>
				...
				<td style=<?= $styleceldas?> class="danger"><p style="margin: 0;"><?= Yii::$app->db->createCommand("select count(*) from ".$tablasconjoin."  where ".$filtrounidad." e1.id = 2 and extract(year from s1.created_at) = ".$model->ano." and e2.id <> 15")->queryscalar();?></p></td>
				<td style=<?= $styleceldas?> class="danger"><p style="margin: 0;"><?= Yii::$app->db->createCommand("select count(*) from ".$tablasconjoin."  where ".$filtrounidad." e1.id = 2 and extract(year from s1.created_at) = ".$model->ano." and e2.id = 15")->queryscalar();?></p></td>
